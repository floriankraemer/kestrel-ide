...
// The PHP tooling plan's B9 (E2 added the mnemonic fix): the "Ana&lysis"
// menu's one action, "Inspect Project" (`analysis.inspectProject`), wired to
// `AnalysisService::inspectProject`. Its own translation unit for the reason
// `build_menu.cpp` and `vcs_menu.cpp` are: `main_window.cpp` sits at its
