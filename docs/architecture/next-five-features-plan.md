...
| F3-24 — diff viewer JetBrains parity: line-number gutters and full-line backgrounds, a divider drawn from real geometry with apply chevrons, aligned scrolling over `editor_core::diff::diff_rows`, whitespace and highlighting modes, an icon toolbar, a unified viewer, and an E2E flow (ADR-0030 §6) | done | (this PR) |
