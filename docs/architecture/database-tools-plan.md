...
| F7.4 — scylla driver + Keyspace tree kind + CQL console | done (crate half, feature opt-in — see §3's `cassandra` note; console view is F7b) | `90a412e` |
