...
graph TB
    ...
    adapter --> support["support: app-config, syntax-core,<br/>index-core, lsp-core, settings-model,<br/>vcs-core, pty-core, terminal-core, run-core,<br/>mcp-server, ai-chat-core, container-core,<br/>container-registry"]
