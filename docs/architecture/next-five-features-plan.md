...
| F3-25 — Git history UI revamp: locale-aware expandable `HistoryListView` shared by File History and a new repo-wide Commit Log panel, commit-detail dock (tab-per-commit, full message + per-file diff) | done | (#235) |
