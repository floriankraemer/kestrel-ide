...
//
// Close-button placement (tabSizeHint/tabInserted/eventFilter/
// placeCloseButton) lives in StyledTabBar; this class adds only the
// drag-out-of-the-strip gesture on top of it.
class PaneTabBar : public StyledTabBar
{
public:
