...
| Task | Status | Commit |
|---|---|---|
| E1 — `overview.md`, `project-structure.md` truthful; ADR status Accepted | done | `ebe552e` |
| E2 — E2E (nightly, gated `IDE_E2E_JVM=1`): Gradle fixture sync → banner → Load → dock → run → Tests dock → pom completion | done | `2dbdeef` |
